    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12">
                <a href="{{url('/')}}/foodCategory/create" class="btn btn-success btn-block">اضافة نوع طعام جديد</a>
            </div>
        </div>
    </div>
    <br>
                    ...
                    @foreach($foods as $food)
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{url('/')}}/foodCategory/{{$food->id}}/edit" class="btn btn-warning"><i class="fa fa-pencil"></i></a>
                                ...
                                <form id="delete-form{{$food->id}}"
                                      action="{{url('/foodCategory/'.$food->id) }}"
                                      method="post"
                                      style="display: none;">
                                    @csrf
